...
async def main() -> None:
    ...
    url = "https://telegram-bot-check-name.herokuapp.com"
    ...
    application = (
        Application.builder().token("5697634365:AAEUgF96qD1wcXtxF5x1tXJSH5CjU18KAYM").updater(None).context_types(context_types).build()
    )
