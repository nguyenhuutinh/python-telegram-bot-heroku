...
TOKEN = '5697634365:AAEUgF96qD1wcXtxF5x1tXJSH5CjU18KAYM'
...
#     dp.add_handler(CommandHandler("show_chats", show_chats))
    ...
    updater.start_webhook(
        ...
        port=int(PORT),
        url_path=TOKEN,
        webhook_url='https://telegram-bot-check-name.herokuapp.com/' + TOKEN
    )
